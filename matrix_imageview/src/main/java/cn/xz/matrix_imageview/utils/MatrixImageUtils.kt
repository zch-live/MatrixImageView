package cn.xz.matrix_imageview.utils

import android.graphics.Matrix
import android.graphics.RectF
import android.view.MotionEvent
import android.widget.ImageView
import cn.xz.matrix_imageview.MatrixImageView
...
object MatrixImageUtils {
     ...
     */
    fun getTouchMode(view: MatrixImageView, x: Float, y: Float): TouchMode {
     ...
     * @return 两个点之间的距离
     */
    fun getDistanceOf2Points(x1: Float, y1: Float, x2: Float, y2: Float): Float {
     ...
     * @return 旋转的角度
     */
    fun callRotation(event: MotionEvent): Float {
